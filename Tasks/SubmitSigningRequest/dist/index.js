    ...
    run() {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const urlBuilder = new signpath_url_builder_1.SignPathUrlBuilder(signPathApiBaseUrl, connectorUrl);
                ...
                const response = (yield axios_1.default
                    .post(urlBuilder.buildSubmitSigningRequestUrl(), submitRequestPayload, { responseType: "json" })
                    .catch((e) => {
                    var _a;
                ...
                if (response.signingRequestId) {
                    ...
                    const requestData = yield polly.default()
                        ...
                        return yield axios_1.default
                            .get(urlBuilder.buildGetSigningRequestUrl(signPathOrganizationId, response.signingRequestId), { responseType: "json" })
                            .then(res => {
